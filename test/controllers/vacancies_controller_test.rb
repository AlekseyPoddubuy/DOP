...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post vacancies_url, params: { vacancy: { body: @vacancy.body, date: @vacancy.date, desc: @vacancy.desc, payment: @vacancy.payment, skills: @vacancy.skills, title: @vacancy.title } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { body: @vacancy.body, date: @vacancy.date, desc: @vacancy.desc, payment: @vacancy.payment, skills: @vacancy.skills, title: @vacancy.title } }
